...
import trubblestack.files.trubblestack_nova.stat_nova
...
class TestStatNova():
    ...
    def test_virtual(self):
        expected_val = True
        val = trubblestack.files.trubblestack_nova.stat_nova.__virtual__()
    ...
    def test_merge_yaml(self):
        ...
        val = trubblestack.files.trubblestack_nova.stat_nova._merge_yaml(ret, data, profile)
    ...
    def test_get_tags(self):
        data = {'stat': [{'passwd_owner_group': {'nova_profile': 'ubuntu-1604-level-1-scored-v1-0-0',
                                                 'data': {'Ubuntu-16.04': [{'/etc/passwd': {'gid': 0, 'tag': 'CIS-12.4', 'group': 'root', 'uid': 0, 'user': 'root'}}]},
                                                 'description': 'Verify User/Group Ownership on /etc/passwd'}}]}
        trubblestack.files.trubblestack_nova.stat_nova.__grains__ = {'osfinger': 'Ubuntu-16.04'}
        ret = trubblestack.files.trubblestack_nova.stat_nova._get_tags(data)
    ...
    def test_audit_for_success(self):
        ...
        trubblestack.files.trubblestack_nova.stat_nova.__salt__ = __salt__
        val = trubblestack.files.trubblestack_nova.stat_nova.audit(data_list, __tags__, debug=False)
    ...
    def test_check_mode_1(self):
        ...
        expected_val = True
        result = trubblestack.files.trubblestack_nova.stat_nova._check_mode(test_data_max_permission, test_data_given_permission, test_data_allow_more_strict)
