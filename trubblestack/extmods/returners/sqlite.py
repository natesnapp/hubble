# -*- coding: utf-8 -*-
'''
Return trubble data to sqlite (intended for testing)
'''
...
def _get_options(ret=None):
    ...
    defaults = {'dumpster': '/var/log/trubblestack/returns.sqlite'}
...
def _get_conn():
    ...
    global _conn
    if not _conn:
        _p = _options.get('dumpster','trubble-returns.db')
        ...
        _conn = sqlite3.connect( _options.get('dumpster', 'trubble-returns.db') )
