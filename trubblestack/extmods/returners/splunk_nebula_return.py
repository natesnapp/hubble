# -*- encoding: utf-8 -*-
'''
TrubbleStack Nebula-to-Splunk returner

Deliver TrubbleStack Nebula query data into Splunk using the HTTP
...
def _get_options():
    if __salt__['grains.get']('trubblestack:returner:splunk'):
        ...
        splunk_opts = {}
        splunk_opts['token'] = __salt__['config.get']('trubblestack:nebula:returner:splunk:token').strip()
        splunk_opts['indexer'] = __salt__['config.get']('trubblestack:nebula:returner:splunk:indexer')
        splunk_opts['port'] = __salt__['config.get']('trubblestack:nebula:returner:splunk:port', '8088')
        splunk_opts['index'] = __salt__['config.get']('trubblestack:nebula:returner:splunk:index')
        splunk_opts['custom_fields'] = __salt__['config.get']('trubblestack:nebula:returner:splunk:custom_fields', [])
        splunk_opts['sourcetype'] = __salt__['config.get']('trubblestack:nebula:returner:splunk:sourcetype')
        splunk_opts['http_event_server_ssl'] = __salt__['config.get']('trubblestack:nebula:returner:splunk:hec_ssl', True)
        splunk_opts['proxy'] = __salt__['config.get']('trubblestack:nebula:returner:splunk:proxy', {})
        splunk_opts['timeout'] = __salt__['config.get']('trubblestack:nebula:returner:splunk:timeout', 9.05)
        splunk_opts['add_query_to_sourcetype'] = \
            __salt__['config.get']('trubblestack:nebula:returner:splunk:add_query_to_sourcetype', True)
