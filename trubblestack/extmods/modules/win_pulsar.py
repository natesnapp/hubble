...
def process(configfile='salt://trubblestack_pulsar/trubblestack_pulsar_win_config.yaml',
            verbose=False):
    '''
    ...
    :return:
    '''
    config = __salt__['config.get']('trubblestack_pulsar' , {})
...
def top(topfile='salt://trubblestack_pulsar/win_top.pulsar',
        verbose=False):
    '''
