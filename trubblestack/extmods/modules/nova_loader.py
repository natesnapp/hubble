...
class NovaLazyLoader(LazyLoader):
    ...
    def __init__(self, trubble_dir, opts, grains, pillar, salt):
        self.trubble_dir = trubble_dir
        ...
        super(NovaLazyLoader, self).__init__(trubble_dir,
                                             opts=opts,
                                             tag='nova')
        self._load_all()
            ...
            for dirname, dirs, files in os.walk(mod_dir):
                ...
                for filename in files:
                    try:
                        ...
                        # quick fix.
                        nova_module_cache, nova_profile_cache = self.trubble_dir
